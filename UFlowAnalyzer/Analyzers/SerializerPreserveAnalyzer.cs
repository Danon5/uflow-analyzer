...
namespace UFlowAnalyzer {
    ...
    internal class SerializerPreserveAnalyzer : DiagnosticAnalyzer {
        ...
        private static void Analyze(SyntaxNodeAnalysisContext context) {
            ...
            var logicInterfaceSymbol =
                semanticModel.Compilation.GetTypeByMetadataName("UFlow.Addon.Serialization.Core.Runtime.ISerializer`1");
